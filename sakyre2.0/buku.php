        ...
        <table border="1" cellspacing="0" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="edit.buku.php?id=<?php echo $row['product_id']  ?>">Edit</a>
                        <a href="">||</a>
                        <a href="proses.hapus.php?idp=<?php echo $row['category_id']  ?>" onclick="return confirm('Are you sure to delete this ?')">Delete</a>
                    </td>
                </tr>
                <?php } }else{?>
                    <tr>
